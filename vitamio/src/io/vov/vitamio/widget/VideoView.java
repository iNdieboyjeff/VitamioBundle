 ...
 * <p/>
 * VideoView also provide many wrapper methods for {@link io.vov.vitamio.MediaPlayer}, such as {@link #getVideoWidth()},
...
public class VideoView extends SurfaceView implements MediaController.MediaPlayerControl {
	...
	private void openVideo(HashMap<String, String> headers) {
		...
		try {
			...
			mMediaPlayer.setDataSource(mUri.toString(), mHeaders);
			mMediaPlayer.setDisplay(mSurfaceHolder);
